...
loading_matrix <- as.data.frame((matrix(fa_5varimax_sorted, ncol = 5, nrow = 23, 
...
loading_matrix <- as.data.frame((matrix(fa_5quartimax_sorted, ncol = 5, nrow = 23, 
...
loading_matrix <- as.data.frame((matrix(fa_5oblimin_sorted, ncol = 5, nrow = 23, 
...
loading_matrix <- as.data.frame((matrix(fa_6varimax_sorted, ncol = 6, nrow = 23, 
...
loading_matrix <- as.data.frame((matrix(fa_6quartimax_sorted, ncol = 6, nrow = 23, 
...
loading_matrix <- as.data.frame((matrix(fa_6oblimin_sorted, ncol = 6, nrow = 23, 
